...
def download_data():
    ...
    blobs = bucket.list_blobs(prefix="cheeses_labeled/")

    # Download annotations
    for blob in blobs:
        print("Annotation file:", blob.name)

        if not blob.name.endswith("cheeses_labeled/"):
